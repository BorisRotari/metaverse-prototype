        ...
        <div className="w-full max-w-sm">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-2xl border border-white/20">
            ...
            <form className="space-y-4">
              {/* Name Input */}
              <div>
                <label htmlFor="name" className="block text-white text-xs font-semibold mb-2">
                  Name
                </label>
                <input
                  type="text"
              ...
              {/* Life Form Dropdown */}
              <div>
                <label htmlFor="lifeForm" className="block text-white text-xs font-semibold mb-2">
                  Life Form
                </label>
                <select
                  id="lifeForm"
                  value={lifeForm}
                  onChange={(e) => setLifeForm(e.target.value)}
                  className="w-full px-4 py-2.5 text-sm rounded-xl bg-white/20 backdrop-blur-md border-2 border-white/30 text-white focus:outline-none focus:border-white/50 focus:bg-white/25 transition-all duration-300 cursor-pointer"
                  style={{
                ...
                >
                  <option value="" disabled className="bg-purple-600">
                    Select your life form
                  </option>
                  <option value="carbon-based" className="bg-purple-600">
                    Carbon-based
                  </option>
                  <option value="silicon-based" className="bg-purple-600">
                    Silicon-based
                  </option>
                  <option value="carbon-silicon-hybrid" className="bg-purple-600">
