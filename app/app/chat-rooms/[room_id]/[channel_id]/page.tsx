    ...
    <>
      ...
      <div className={`md:hidden fixed inset-y-0 left-0 z-[70] flex transition-transform duration-300 ${showMobileMenu ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="px-2 py-2 border-b border-white/20 space-y-1.5">
          <button className={`text-sm px-2 py-1.5 rounded cursor-pointer flex items-center gap-2 transition-all duration-200 w-full font-medium ${currentTheme.buttonBg} ${currentTheme.buttonHover} ${currentTheme.buttonText}`}>
